 ...
 * @author michel
 */
public class CompositingRaycastRenderer extends RaycastRenderer {
            ...
            for (int i = 0; i < image.getWidth(); i++) {
                ...
                for (double k = 1; k < samples; k++) {
                    ...
                    if ((x >= 0) && (x < volume.getDimX()) && (y >= 0) && (y < volume.getDimY())
                        ...
                        pixelRed = voxelColor.r * voxelColor.a + (1 - voxelColor.a) * pixelRed;
                        pixelGreen = voxelColor.g * voxelColor.a + (1 - voxelColor.a) * pixelGreen;
